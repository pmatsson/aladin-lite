...
impl Image {
        ...
        R: AsyncReadExt + Unpin,
    {
        ...
        let (textures, mut cuts, cut_limits) = if width <= max_tex_size as u64 && height <= max_tex_size as u64
        {
            ...
            unsafe {
                ...
                let cut_limits = if F::NUM_CHANNELS == 1 {
    ...
    pub fn get_cut_limits(&self) -> &Range<f32> {
        &self.cut_limits
    }
